...
app_controllers.controller('MenuCtrl', ['$rootScope', 'visAPI',
    function($rootScope, visAPI) {
...
app_controllers.controller('MapCtrl', ['$rootScope', 'visAPI',
    function($rootScope, visAPI) {
...
app_controllers.controller('SearchCtrl_deprecated', ['$rootScope',
    function($rootScope) {
...
app_controllers.controller('AppCtrl', ['$scope', '$interval', '$q', 'visAPI',
    function($scope, $interval, $q, visAPI) {
...
app_controllers.controller('SearchCtrl', ['$scope', '$rootScope', '$http', 'limitToFilter',
    function($scope, $rootScope, $http, limitToFilter) {
