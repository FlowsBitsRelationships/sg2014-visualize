...
*/
    ...
    // Uses terrainGen and OSM3 to build the context model
    ...
    // Find the lowest elevation among a set of vertices
    ...
    // Find the point on the terrain mesh that intersects the building
    ...
    */
    ...
    this.clear_scene = function() {
        ...
        for (var i = children.length - 1; i >= 0; i--) {
            ...
            if (child.name === "xz-plane" || dont_clear) {} else {
                scene.remove(child);
            }
        };
