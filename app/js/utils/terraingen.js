var TerrainGen = function() {
    ...
    /* 
     * ThreeJS terrain generator - takes a latLon bounding box, generates a grid of points
     * calls the elevation API end point to obtain a collection of 3-tuples: lat, lon, el.
     * adds this mesh to the scene.
     */
    ...
    this.set_Elevations = function(geometry, scene, x_step, callback) {
        ...
        $.when($.ajax('/elevation', {
            'data': JSON.stringify({
                latLngCollection: vertex_latLons.join(",")
